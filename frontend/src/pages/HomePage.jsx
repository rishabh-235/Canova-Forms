...
function HomePage() {
  ...
  return (
    <div className="homepage-container">
      ...
      <div className="homepage-content">
        <section className="create-project-section">
          <div className="create-project-button">
            <div onClick={() => setToggleCreateProjectCard(!togglecreateProjectCard)}>
              <svg
                width="23"
                height="21"
                viewBox="0 0 23 21"
      ...
      {togglecreateProjectCard && <CreateProjectCard toggleCreateProjectCard={togglecreateProjectCard} setToggleCreateProjectCard={setToggleCreateProjectCard} />}
    </div>
  );
}
